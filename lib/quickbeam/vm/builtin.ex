defmodule QuickBEAM.VM.Builtin do
  ...
  def call({:builtin, name, _cb}, _args, _this)
      when name in ~w(Map Set WeakMap WeakSet WeakRef FinalizationRegistry DataView Promise Proxy Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float16Array Float32Array Float64Array BigInt64Array BigUint64Array) do
